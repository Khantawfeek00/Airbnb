...
import com.tk.airbnb.Airbnb.Model.HotelMinPriceEntity;
...
public interface HotelMinPriceRepository extends JpaRepository<HotelMinPriceEntity, Long> {
    ...
    @Query("""
             SELECT new com.tk.airbnb.Airbnb.DTO.HotelPriceDTO(i.hotel, AVG(i.price))
    ...
    Optional<HotelMinPriceEntity> findByHotelAndDate(Hotel hotel, LocalDate date);
}
